...
import br.com.italo.springrest.avaliacaodesoftware.dao.UsuarioDao;
...
public class UsuarioController {
	...
	public String save(@Valid @ModelAttribute("usuario") Usuario usuario, BindingResult result, RedirectAttributes attr) {
		...
		dao.salvar(usuario);
		attr.addFlashAttribute("message", "UsuÃ¡rio salvo com sucesso.");
	...
	public ModelAndView update(@Valid @ModelAttribute("usuario") Usuario usuario, BindingResult result, RedirectAttributes attr) {
		...
		dao.editar(usuario);
		attr.addFlashAttribute("message", "UsuÃ¡rio alterado com sucesso.");
		return new ModelAndView("redirect:/usuario/todos");
	}
	...
	public String delete(@PathVariable("id") Long id, RedirectAttributes attr) {
		dao.excluir(id);
		attr.addFlashAttribute("message", "UsuÃ¡rio excluÃ­do com sucesso.");
		return "redirect:/usuario/todos";
	}
